...
//tbl_investment
if (!table_exists("tbl_investment")) {
    $query = "CREATE TABLE `tbl_investment` (";
    $query .= "`id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,";
    $query .= "`name` VARCHAR(255) NOT NULL DEFAULT 'NULL',";
    $query .= "`amount` VARCHAR(255) NOT NULL DEFAULT 'NULL',";
